...
namespace MichaelNabil230\Msegat\Responses;

use Illuminate\Http\Client\Response;
use MichaelNabil230\Msegat\Exceptions\MsegatException;
...
class MsegatResponse
{
    ...
    /**
     * Format the response from Msegat.
     */
    public function format(): array
    {
        $message = $this->getMessageFromResponse();

        throw_if($message !== 'Success', new MsegatException($message));
    ...
    /**
     * Get the Message error from response Msegat.
     */
    protected function getMessageFromResponse(): string
    {
