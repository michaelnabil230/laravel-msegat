...
[![GitHub Tests Action Status](https://img.shields.io/github/workflow/status/michaelnabil230/laravel-msegat/run-tests?label=tests)](https://github.com/michaelnabil230/laravel-msegat/actions?query=workflow%3Arun-tests+branch%3Amain)
[![GitHub Code Style Action Status](https://img.shields.io/github/workflow/status/michaelnabil230/laravel-msegat/Check%20&%20fix%20styling?label=code%20style)](https://github.com/michaelnabil230/laravel-msegat/actions?query=workflow%3A"Check+%26+fix+styling"+branch%3Amain)
...
```bash
php artisan vendor:publish --tag="laravel-msegat-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-msegat-views"
```

## Usage

```php
$laravelMsegat = new MichaelNabil230\LaravelMsegat();
echo $laravelMsegat->echoPhrase('Hello, MichaelNabil230!');
```
